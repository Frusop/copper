...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CopperTestFramework
    pass

class ExampleTest(CopperTestFramework):
    # Each functional test is a subclass of the CopperTestFramework class.
    ...
    def custom_method(self):
        ...
        CopperTestFramework class so other tests can use it."""
