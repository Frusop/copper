...
class BIP66Test(CopperTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # copperd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and copperd produces more specific reject
            # reasons.
