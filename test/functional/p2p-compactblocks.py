...
# TestNode: A peer we use to send messages to copperd, and store responses.
...
class CompactBlocksTest(CopperTestFramework):
    ...
    # This test actually causes copperd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that copperd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for copperd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # copperd will not send blocktxn responses for blocks whose height is
