...
By default, copperd will dump mempool on shutdown and
...
class MempoolPersistTest(CopperTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give copperd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent copperd from writing mempool.dat to disk. Verify that `savemempool` fails")
