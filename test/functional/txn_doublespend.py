...
class TxnMallTest(CopperTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 CU:
        ...
        # First: use raw transaction API to send 1240 CU to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 CU coin each
        ...
        # Node0's balance should be starting balance, plus 50CU for another
        ...
        # Node0's total balance should be starting balance, plus 100CU for 
