...
This document provides guidelines for internationalization of the Copper Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `copper_en.ts` remains unchanged.
