...
#ifndef COPPER_QT_COPPERUNITS_H
#define COPPER_QT_COPPERUNITS_H
...
/** Copper unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CopperUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CopperUnits(QObject *parent);

    /** Copper units.
      @note Source: https://en.copper.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CU,
...
typedef CopperUnits::Unit CopperUnit;

#endif // COPPER_QT_COPPERUNITS_H
