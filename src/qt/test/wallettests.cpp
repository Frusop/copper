...
#include "qt/copperamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CopperAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_copper-qt -platform xcb      # Linux
//     src/qt/test/test_copper-qt -platform windows  # Windows
//     src/qt/test/test_copper-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CopperUnits::formatWithUnit(unit, balance, false, CopperUnits::separatorAlways);
    ...
    // Amount input
    CopperAmountField* amountInput = receiveCoinsDialog.findChild<CopperAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: copper:")) != -1);
