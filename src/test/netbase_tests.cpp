...
{
    BOOST_CHECK(TestSplitHost("www.copper.org", "www.copper.org", -1));
    BOOST_CHECK(TestSplitHost("[www.copper.org]", "www.copper.org", -1));
    BOOST_CHECK(TestSplitHost("www.copper.org:80", "www.copper.org", 80));
    BOOST_CHECK(TestSplitHost("[www.copper.org]:80", "www.copper.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7994", "127.0.0.1", 7994));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7994", "127.0.0.1", 7994));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7994", "::ffff:127.0.0.1", 7994));
    BOOST_CHECK(TestSplitHost("[::]:7994", "::", 7994));
    BOOST_CHECK(TestSplitHost("::7994", "::7994", -1));
    BOOST_CHECK(TestSplitHost(":7994", "", 7994));
    BOOST_CHECK(TestSplitHost("[]:7994", "", 7994));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7994", "127.0.0.1:7994"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7994", "[::]:7994"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
