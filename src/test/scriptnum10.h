...
#ifndef COPPER_TEST_SCRIPTNUM10_H
#define COPPER_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Copper Core 0.10.0, for cross-comparison.
 */
public:
