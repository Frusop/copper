...
#if defined(NDEBUG)
# error "Copper cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Copper Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s CU additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = 350 * COIN;
    if(nHeight <= 1){
        nSubsidy = 16320000 * COIN;
    } else if(nHeight < 240){ 
        nSubsidy = 0 * COIN;
    } else {
        nSubsidy = 350 * COIN;
